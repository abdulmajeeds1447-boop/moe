            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-3 gap-3">
                   <button onClick={saveEvaluation} className="py-5 bg-[#0d333f] text-white rounded-3xl font-black shadow-lg">حفظ</button>
                   <button onClick={() => window.print()} className="py-5 bg-slate-200 text-[#0d333f] rounded-3xl font-black shadow-sm">طباعة</button>
                   <button onClick={shareOnWhatsapp} className="py-5 bg-[#25D366] text-white rounded-3xl font-black shadow-lg flex items-center justify-center gap-2">
